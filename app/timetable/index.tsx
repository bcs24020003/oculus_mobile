...
export default function TimetableScreen() {
  ...
  const fetchTimetable = async () => {
    ...
    try {
      ...
      if (!currentUser) {
        setError('You must be logged in to view your timetable');
        setLoading(false);
        return;
      }
      ...
      if (!studentDoc.exists()) {
        ...
        setError('No student record found. Please contact admin for assistance.');
        setLoading(false);
        return;
      }
      ...
      if (fetchedClasses.length === 0) {
        setError('No classes have been scheduled for you yet.');
      } else {
